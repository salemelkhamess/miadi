        ...
        child: Padding(
          ...
          child: Column(
            children: <Widget>[
                ...
                children: [
                  CircleAvatar(
                    backgroundImage: NetworkImage(
                        "http://192.168.43.164:8000${widget.doctor['doctor_profile']}"), //insert doctor profile
                  ),
                  const SizedBox(
                    width: 10,
                  ),
              ...
              //Schedule info here
              ScheduleCard(
                appointment: widget.doctor['time'],
              ),
              Config.spaceSmall,
              //action button
              Row(
                        ...
                        showDialog(
                            ...
                            builder: (context) {
                              return RatingDialog(
                                  ...
                                  message: const Text(
                                    'Aidez-nous à évaluer notre Site',
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                      fontSize: 15,
                                    ),
